      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            <AnimatedBody
              text={
                "With over 8 years of experience in digital content strategy, I've helped creators and brands build meaningful connections with their audiences through strategic content."
              }
            />
            <AnimatedBody
              text={
            ...
            <AnimatedBody
              text={
                "After working with top influencers and seeing the gaps in content management services, I founded J Curve to provide creators with the personalized attention and results-driven strategies they deserve."
              }
            />
            <AnimatedBody
              text={
